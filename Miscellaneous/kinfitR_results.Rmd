...
Save pbr28 data just with the macroparameter Vt in a similar format to the PMOD
...
Save pk11195 data just with the macroparameter Vt in a similar format to the PMOD
...
Save SCH23390 data just with the macroparameter Vt in a similar format to the PMOD
...
Save AZ10419369 data just with the macroparameter Vt in a similar format to the PMOD
...
As different regions are required for different tracers, I will create 4 different datasets, one for each tracer, and then filter by the regions I want and then combine the datasets once again. OC and FC for "9369" (az), THA and FC for pbr28 and pk11195 as both are TSPO-ligands. STR and FC for SCH.
